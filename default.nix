...
let
  ...
  torchaudio = python38.pkgs.buildPythonPackage rec {
    pname = "torchaudio";
    version = "0.7.2";
    src = fetchFromGitHub {
      owner  = "pytorch";
    ...
    propagatedBuildInputs = (with unstable.python38Packages; [
      pytorch-bin
    ]) ++ [sox];
  };
  torchvision_wheel = python38.pkgs.buildPythonPackage rec {
    pname = "torchvision";
    version = "0.8.2";
  ...
  lesscpy = python38.pkgs.buildPythonPackage rec {
    pname = "lesscpy";
    version = "0.13.0";
    src = fetchFromGitHub {
      owner  = "lesscpy";
  ...
  jupyterthemes = python38.pkgs.buildPythonPackage rec {
